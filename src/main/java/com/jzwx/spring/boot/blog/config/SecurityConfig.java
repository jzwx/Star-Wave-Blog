package com.jzwx.spring.boot.blog.config;
 ...
 *
 * @author jzwx
 * @version $ Id: SecurityConfig, v 0.1 2018/2/20 20:31 jzwx Exp $
 */
@EnableWebSecurity
@EnableGlobalMethodSecurity(prePostEnabled = true) //启用方法安全设置
public class SecurityConfig extends WebSecurityConfigurerAdapter{

    private static final String KEY = "jzwx.com";
...
//                .antMatchers("/css/**","/js/**","/fonts/**","/index").permitAll();//都可以访问
        ...
        http.headers().frameOptions().sameOrigin();//允许来自同一来源的H2 控制台请求
    }
